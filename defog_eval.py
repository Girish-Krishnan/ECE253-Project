...
from fast_alpr_wrapper import run_fast_alpr
...
def main():
    ...
    if "filename" not in df_labels.columns or "plate" not in df_labels.columns:
        raise ValueError("labels_csv must have 'filename' and 'plate' columns")
    ...
    for _, row in df_labels.iterrows():
        ...
        # Run ALPR
        pred_raw = run_fast_alpr(img_raw)
        pred_defog = run_fast_alpr(img_defog)
